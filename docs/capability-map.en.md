...
Use this page to check which first-class capabilities `ChatModel` currently owns, which ones are verified, and what remains out of scope for this package.
...
- **CLI Entry**
    ...
    `chatmodel --help` and `chatmodel --version` are the default verification entry points.
